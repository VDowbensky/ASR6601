...
extern TimerTime_t g_systime_ref;
...
SysTime_t SysTimeGet( void )
{
    ...
    sysTime.Seconds = (TimerTime_t)(curTime/1000);
...
SysTime_t SysTimeGetMcuTime( void )
{
    ...
    calendarTime.Seconds = (TimerTime_t)(curTime/1000);
    calendarTime.SubSeconds = (uint16_t)(curTime%1000);
...
SysTime_t SysTimeFromMs( TimerTime_t timeMs )
{
    ...
    sysTime.Seconds = (TimerTime_t)((timeMs)/1000);
    sysTime.SubSeconds = (uint16_t)((timeMs)%1000);
